...
@DynamoDBTable(tableName = Contest.TABLE_NAME)
@ToString
public class Contest implements Serializable {
    ...
    @Lob
    @Column(name = "logo")
    @DynamoDBTypeConverted(converter = DynamoConverters.ByteArrayConverter.class)
    private byte[] logo;
    ...
    @DynamoDBTypeConverted(converter = DynamoConverters.LocalDateConverter.class)
    ...
    @DynamoDBTypeConverted(converter = DynamoConverters.BigDecimalConverter.class)
